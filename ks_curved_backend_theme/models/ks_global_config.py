...
class KsThemeGlobalConfig(models.Model):
    ...
    ks_is_font_color_on_hover = fields.Boolean(string="Enable Font Color", default=False)
    ks_font_color_on_hover = fields.Char(string="Font Color", default=False)
    ...
    scope_ks_font_hover_color = fields.Selection(
        selection=[('User', 'User'), ('Company', 'Company'), ('Global', 'Global')], default='User')
    ...
    def ks_get_config_values(self):
        ...
        if ks_global_data:
            values = {
                ...
                'scope_ks_font_hover_color': ks_global_data.scope_ks_font_hover_color,
            }
        return values
    ...
    def ks_get_global_setting(self):
        ...
        values = {
            ...
            'ks_is_font_color_on_hover': ks_global_data.ks_is_font_color_on_hover,
            'ks_font_color_on_hover': ks_global_data.ks_font_color_on_hover,
        }
        return values
