# -*- coding: utf-8 -*-
{
    ...
    'images': [
        'static/description/Financial Year End sale (1).gif',
        'static/description/Financial Year year sale-Top vertical.gif'
    ...
    'assets': {
        ...
        'web.assets_backend': [
            ...
            '/ks_curved_backend_theme/static/src/js/ks_arc_tag.js',
