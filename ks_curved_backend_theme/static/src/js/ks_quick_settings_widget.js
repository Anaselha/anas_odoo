...
//            this._ksManageCurrentColorTheme();
        ...
        _ksManageCurrentColorTheme() {
           ...
           if (ks_current_theme.ks_is_font_color_on_hover){

                document.body.style.setProperty("--color", ks_current_theme.ks_font_color_on_hover);
                document.body.style.setProperty("--table-td-color", ks_current_theme.ks_font_color_on_hover);
                document.body.style.setProperty("--table-th-color", ks_current_theme.ks_font_color_on_hover);
           }
