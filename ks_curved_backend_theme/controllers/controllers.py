...
class KsCurvedBackendTheme(http.Controller):
    ...
    def render_theme_view_settings(self, ks_setting_scope, ks_rec_id=None):
        ...
        if ks_setting_scope == 'Global':
            ...
            values['ks_is_font_color_on_hover'] = ks_origin_data.ks_is_font_color_on_hover
            values['ks_font_color_on_hover'] = ks_origin_data.ks_font_color_on_hover
    ...
    def ks_app_frequency_render(self):
        ...
        menu_ids = user_id.ks_frequency_menu.search_read(
            [('ks_user_id', '=', user_id.id), ('ks_menu_id', 'in', menus.ids)], ['ks_menu_id'], limit=12,
    ...
    def ks_get_theme(self):
        ...
        if ks_scope == 'Global':
            ...
            ks_color_theme_domain = [('ks_global', '=', True), ('ks_active', '=', True)]
        ks_origin_obj = request.env.ref('ks_curved_backend_theme.ks_global_config_single_rec')
        ks_is_font_color_on_hover = request.env.ref(
            'ks_curved_backend_theme.ks_global_config_single_rec').ks_is_font_color_on_hover
        if ks_is_font_color_on_hover:
            ks_font_color_on_hover = request.env.ref(
                'ks_curved_backend_theme.ks_global_config_single_rec').ks_font_color_on_hover
        else:
            if request.env.user.ks_dark_mode:
                ks_font_color_on_hover = '#ffffff'
            else:
                ks_font_color_on_hover = '#454546'
        ...
        if ks_current_theme_data:
            return {
                ...
                'ks_is_font_color_on_hover': ks_is_font_color_on_hover,
                'ks_font_color_on_hover': ks_font_color_on_hover,
            }
        return {
            'primary': '#28C397',
