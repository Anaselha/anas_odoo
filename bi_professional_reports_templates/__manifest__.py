...

{
    ...
    'depends': ['web','base', 'account', 'sale', 'purchase', 'stock', 'sale_stock', 'base_vat','sale_management','purchase_stock'],
    'data': [
    ...
    "assets": {
        "web.report_assets_pdf": [
            "/bi_professional_reports_templates/static/src/css/set_watermark.css"
        ],
    },
    'demo': [],
    'test': [],
